...
TITLE "Same strings"
"include(logic/are_not_equal)"
"_cpp_are_not_equal(test \"hello world\" \"hello world\")"
"_cpp_assert_false(test)"
)
...
"include(logic/are_not_equal)"
"_cpp_are_not_equal(test \"hello world\" \"goodbye world\")"
"_cpp_assert_true(test)"
)
...
"_cpp_are_not_equal(test \"\${list1}\" \"\${list1}\")"
"_cpp_assert_false(test)"
)
...
"_cpp_are_not_equal(test \"\${list1}\" \"\${list2}\")"
"_cpp_assert_true(test)"
)
